          ...
          <div className="flex flex-col gap-20 relative z-10">
            {experiences.map((exp, i) => {
              ...
              return (
                ...
                >
                  {/* LEFT SIDE — Date + Dot (for left entry) */}
                  {!isRight && (
                    <div className="hidden md:flex flex-col items-end justify-start w-1/2 pr-6 relative">
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <div className="w-4 h-4 rounded-full bg-indigo-600 border-[4px] border-white dark:border-slate-900 shadow" />
                      </div>
                    </div>
                  )}

                  {/* RIGHT SIDE — Dot + Date (for right entry) */}
                  {isRight && (
                  ...
                  >
                    ...
                    >
                      <h3 className="text-lg font-bold text-indigo-600 mb-1">{exp.position}</h3>
