    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-primary-500 via-accent-500 to-success-500 rounded-full" />
          ...
          <div className="space-y-8 sm:space-y-12">
            {experience.map((job, index) => (
              ...
              >
                ...
                <div className="md:hidden absolute left-4 top-6 w-3 h-3 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full border-2 border-white shadow-lg z-10" />
                
                {/* Timeline Dot - Desktop version */}
                <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 top-6 w-4 h-4 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full border-4 border-white shadow-lg z-10" />

                {/* Content Card */}
                <motion.div
                  className={`md:ml-0 md:w-5/12 ${
                ...
                >
                  ...
                  <div className="md:hidden ml-12">
                    <div className={`relative p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg ${
                      darkMode
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-primary-500/5 to-accent-500/5 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-xl sm:rounded-2xl" />
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="mb-4">
                          <div className="flex items-center gap-2 mb-2">
                            <FaBuilding className="text-primary-500" size={16} />
                          ...
                          {index === 0 && (
                            <span className="inline-block px-2 py-1 bg-gradient-to-r from-success-500 to-success-600 text-white text-xs font-medium rounded-full animate-pulse mt-2">
                              Current
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4 text-sm">
                          <div className="flex items-center gap-2">
                            <FaMapMarkerAlt className="text-accent-500" size={12} />
                            <span className={darkMode ? "text-gray-400" : "text-gray-600"}>
                              {job.location}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <FaCalendarAlt className="text-accent-500" size={12} />
                            <span className={darkMode ? "text-gray-400" : "text-gray-600"}>
                              {job.period}
                            </span>
                          </div>
                        ...
                        <div className="space-y-3">
                          <h5 className={`font-semibold flex items-center gap-2 text-sm sm:text-base ${
                            ...
                            <FaCheckCircle className="text-success-500" size={14} />
                            Key Achievements
                          </h5>
                          <ul className="space-y-2">
                            {job.achievements.map((achievement, achievementIndex) => (
                              ...
                              >
                                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-success-500 rounded-full mt-1.5 sm:mt-2 flex-shrink-0" />
                      ...
                      {/* Hover effect line */}
                      <div className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-primary-500 to-accent-500 transform scale-x-0 hover:scale-x-100 transition-transform duration-300 origin-left rounded-b-xl sm:rounded-b-2xl" />
                    </div>
                  </div>
