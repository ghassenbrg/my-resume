...
> **NOTE: Add automated tests first when the story introduces logic worth protecting.
> Manual QA tasks for UI behavior still belong in every story.**

- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [US1] Verify responsive layout, keyboard flow, and reduced-motion behavior for [user journey]
...
- [ ] T018 [US1] Update analytics/content/docs touched by User Story 1
...
- [ ] T021 [US2] Verify responsive layout, keyboard flow, and reduced-motion behavior for [user journey]
...
- [ ] T026 [US2] Update analytics/content/docs touched by User Story 2
...
- [ ] T029 [US3] Verify responsive layout, keyboard flow, and reduced-motion behavior for [user journey]
...
- [ ] T033 [US3] Update analytics/content/docs touched by User Story 3
...
- [ ] TXXX [P] Additional unit tests in tests/unit/ where logic warrants them
- [ ] TXXX Accessibility audit for keyboard flow, focus states, and reduced motion
- [ ] TXXX Verify analytics events and runtime documentation updates
- [ ] TXXX Security hardening
- [ ] TXXX Run build/generate and quickstart.md validation
...
- Verification and documentation updates before story sign-off
...
- Automated tests for a user story marked [P] can run in parallel
...
Task: "Verify responsive layout, keyboard flow, and reduced-motion behavior for [user journey]"
...
- Verify automated tests fail before implementing when they are part of the plan
